...
class Settings(BaseSettings):
    ...
    # непрочитанные" на странице списка диалогов (vk.com/im) — см.
    # VkInboxAdapter._list_unread_conversation_titles. Включено по умолчанию: подтверждено
    # вживую 2026-08-21 и на отрицательном случае (0 совпадений среди лидов без ответа), и на
    # положительном (реальный новый ответ найден и не пропущен).
